...
tests/          Vitest test suite (672 tests across 14 files)
...
All 672 tests must pass before merging. Do not reduce the test count.
...
- Run `npm run test:run` and ensure all 672+ tests pass
